(ert-deftest snakehump--split-names-t ()
  (let ((expected '("foo" "bar" "baz")))
    (dolist (string '("foo_bar_baz" "foo-bar-baz" "FOO_BAR_BAZ" "fooBarBaz"
...
(ert-deftest snakehump-loud-t ()
  (should (equal (snakehump-loud "foo-bar-baz") "FOO_BAR_BAZ"))
  (should (equal (snakehump-loud "foo")         "FOO"))
)
...
(ert-deftest snakehump-snake-p-t ()
  ...
  (should (equal (snakehump-snake-p "FOO_BAR_BAZ")   nil))
  (should (equal (snakehump-snake-p "Foo::Bar::Baz") nil))
...
(ert-deftest snakehump-loud-p-t ()
  (should (equal (snakehump-loud-p "foo_bar_baz")   nil))
  (should (equal (snakehump-loud-p "foo-bar-baz")   nil))
  (should (equal (snakehump-loud-p "FOO_BAR_BAZ")   t))
  (should (equal (snakehump-loud-p "Foo::Bar::Baz") nil))
  (should (equal (snakehump-loud-p "FooBarBaz")     nil))
  (should (equal (snakehump-loud-p "fooBarBaz")     nil))
)
...
(ert-deftest snakehump-current-format-t ()
  ...
  (should (equal (snakehump-current-format "FOO_BAR_BAZ")   'loud))
...
(ert-deftest snakehump-format-t ()
  ...
  (should (equal (snakehump-format "foo-bar-baz" 'loud)  "FOO_BAR_BAZ"))
...
;;; Next / Prev
(ert-deftest snakehump-current-format-t ()
  (let ((snakehump-hump-cycle '(snake dash colon loud camel drom)))
...
(ert-deftest snakehump-current-format-custom-t ()
  (let ((snakehump-hump-cycle '(drom camel colon dash loud snake)))
    (should (equal (snakehump-next "fooBarBaz"    ) "FooBarBaz"    ))
    (should (equal (snakehump-next "FooBarBaz"    ) "Foo::Bar::Baz"))
    (should (equal (snakehump-next "Foo::Bar::Baz") "foo-bar-baz"  ))
    (should (equal (snakehump-next "foo-bar-baz"  ) "FOO_BAR_BAZ"  ))
    (should (equal (snakehump-next "FOO_BAR_BAZ"  ) "foo_bar_baz"  ))
    (should (equal (snakehump-next "foo_bar_baz"  ) "fooBarBaz"))
    )
)
